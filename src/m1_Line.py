...
class Line(object):
    ...
    def line_plus(self, other_line):
        ...
        new_startx = self.start.x + other_line.start.x
        new_starty = self.start.y + other_line.start.y
        new_endx = self.end.x + other_line.end.x
        new_endy = self.end.y + other_line.end.y
        return Line(Point(new_startx,new_starty),Point(new_endx,new_endy))
    ...
    def midpoint(self):
        ...
        my=self.start.y + dy/2
        mx=self.start.x + dx/2
        return Point(mx,my)
    ...
    def is_parallel(self, line2):
        ...
        m1 = self.slope()
        m2 = line2.slope()
        return round(m1,12) == round(m2,12)
